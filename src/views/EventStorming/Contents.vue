            ...
            breadCrumb() {
                ...
                Object.keys(this.$route.params).forEach(function (key, idx) {
                    ...
                    if (idx != 0) {
                        ...
                        } else if (text == '비즈니스 프로세스와 BPM') {
                            href = '/#/비즈니스 프로세스와 BPM/01_기업과%20비즈니스%20프로세스'
                        } else if (text == '워크플로우') {
                            href = '/#/워크플로우/01_워크플로우%20개념과%20유형'
                        } else if (text == '워크플로우 관리 시스템과 RTE BPM') {
                            href = '/#/워크플로우 관리 시스템과 RTE BPM/01_워크플로우%20관리%20시스템(WFMS)'
                        } else if (text == '오픈소스 BPMS uEngine 소개') {
                            href = '/#/오픈소스 BPMS uEngine 소개/01_오픈소스%20BPMS%20uEngine%20소개'
                        }else if (text == '모델링 툴의 사용법') {
                            href = '/#/모델링 툴의 사용법/01_프로세스%20정의%20만들기'
                        }else if (text == '사람간의 프로세스 Workflow') {
                            href = '/#/사람간의 프로세스 Workflow/01_조건분기%20흐름제어'
                        }
                    }
